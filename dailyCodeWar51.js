...
// return the sum of the two smallest numbers multiplied by the largest number

// edge case if we have all 1's we just return 3 since that is the only possible outcome
// there must be brute force solution where you wont have to run edge cases but this is what I have for now